...
public class TLRPC {
    ...
    public static class User extends TLObject {
        ...
        public String toString() {
            ...
            sb.append("access_hash: ").append(access_hash).append("\n");
            ...
            sb.append("mutual_contact: ").append(mutual_contact).append("\n");
            sb.append("deleted: ").append(deleted).append("\n");
            sb.append("bot: ").append(bot).append("\n");
            sb.append("bot_chat_history: ").append(bot_chat_history).append("\n");
            sb.append("bot_nochats: ").append(bot_nochats).append("\n");
            sb.append("verified: ").append(verified).append("\n");
            sb.append("explicit_content: ").append(explicit_content).append("\n");
            sb.append("bot_info_version: ").append(bot_info_version).append("\n");
            sb.append("restricted: ").append(restricted).append("\n");
            sb.append("min: ").append(min).append("\n");
            sb.append("bot_inline_geo: ").append(bot_inline_geo).append("\n");
            sb.append("restriction_reason: ").append(restriction_reason).append("\n");
            sb.append("bot_inline_placeholder: ").append(bot_inline_placeholder).append("\n");
            return sb.toString();
        }
